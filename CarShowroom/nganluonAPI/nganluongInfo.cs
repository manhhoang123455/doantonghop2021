...
namespace ShopThoiTrang.nganluonAPI
{
    public class nganluongInfo
    {
        ...
        public static readonly string return_url = "https://localhost:44353/confirm-orderPaymentOnline";
        // dường dẫn khi thanh tán thất bại
        public static readonly string cancel_url = "https://localhost:44353/cancel-order";
