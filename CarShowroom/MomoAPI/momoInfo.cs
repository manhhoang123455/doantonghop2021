...
namespace ShopThoiTrang.MomoAPI
{
    public class momoInfo
    {
        ...
        public static readonly string returnUrl = "https://localhost:44353/confirm-orderPaymentOnline-momo";
        public static readonly string notifyurl = "https://localhost:44353/cancel-order-momo";
    }
}